...
//     for(auto e : a) if(e == '1') fa = true;
//     for(auto e : b) if(e == '1') fb = true;
//     if(fa != fb) {
//         cout << "-1\n";
//         return;
//     }
...
//         ans.push_back(x);
//         if(x > 0)
//             for(int i = 0;i < n && x < n;i++, x++){
//                 a[i] = (a[i] - '0') ^ (a[x] - '0') + '0';
//             }      
//         else{
//             string tmp = a;
//             for(int i = -x;i < n;i++){
//                 a[i] = ((a[i] - '0') ^ (tmp[i + x] - '0')) + '0';
//             }
//         }  
//     };
...
//     while(l < r){
//         bool f = true;
//         while(l < r && (getsum(n+1) - getsum(a[l]) == 0 || getsum(a[l]-1) == 0)){
//             add(a[l], -1); 
//             l++;
//             f = false;
//         }
//         while(l < r && (getsum(n+1) - getsum(a[r]) == 0 || getsum(a[r]-1) == 0)){
//             add(a[r], -1); 
//             r--;
//             f = false;
//         }
