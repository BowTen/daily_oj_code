...
//					if (j == 1 || j == len)
//						printf("|");
//					else if (j == 3 || j == 2 + n || j == 5 + 2 * n || j == 4 + 3 * n || j == 6 + 3 * n || j == 5 + 4 * n)//��ӡ��������
//						printf("%c", ch);
//					else if(j > 3 && j < 2 + n && i == (hi+1)/2)//H�ĺ���
//						printf("%c", ch);
//					else if ((i == 3 || i == hi-2) && j >= 4 + n && j <= 3 + 2 * n)//��ӡZ�ĺ���
//						printf("%c", ch);
...
//						i2 = i;
//					}
//					else if(j > 6 + 3 * n && j < 5 + 4 * n && i == hi - 2)//U�ĺ���
//						printf("%c", ch);
//					else printf(" ");
//				}
//			}
...
// 	printf("\n________________________按任意键结束");
// 	getchar();getchar();
// 	return 0;
// }
